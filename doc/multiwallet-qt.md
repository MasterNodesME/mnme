...
In order to support loading of multiple wallets in masternodesme-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is masternodesme.cpp.
...
Changes to masternodesme.cpp
----------------------
masternodesme.cpp is the entry point into masternodesme-qt, and as such, will require some minor modifications to provide hooks for
