Contributing to MasterNodesME
============================

The MasterNodesME project operates an open contributor model where anyone is
...
The following applies to code changes to the MasterNodesME project, and is not to be
confused with overall MasterNodesME Network Protocol consensus changes.

Whether a pull request is merged into MasterNodesME rests with the project merge
...
Patches that change MasterNodesME consensus rules are considerably more involved than
...
Where a patch set proposes to change the MasterNodesME consensus, it must have been
...
The project leader is the release manager for each MasterNodesME release.
