...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("MasterNodesME");
    ...
    QString copyrightTextMasterNodesME = QChar (0xA9) + QString (" 2021-%1 ").arg (COPYRIGHT_YEAR) + QString (tr("The MasterNodesME developers"));
	...
	pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 48, copyrightTextMasterNodesME);
