...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MasterNodesME"),
     ...
     * override -datadir in the masternodesme.conf file in the default data directory
     * (to be consistent with masternodesmed behavior)
     */
    if (dataDir != getDefaultDataDirectory())
