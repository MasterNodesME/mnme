...
/* MasterNodesME GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MasterNodesME"
#define QAPP_ORG_DOMAIN "masternodesme.online"
#define QAPP_APP_NAME_DEFAULT "MasterNodesME-Qt"
#define QAPP_APP_NAME_TESTNET "MasterNodesME-Qt-testnet"
