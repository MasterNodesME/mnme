...
void AddressTableModel::updateEntry(const QString& address,
    ...
    int status)
{
    // Update address book model from MasterNodesME
...
{
    emit dataChanged(index(idx, 0, QModelIndex()), index(idx, columnme.length() - 1, QModelIndex()));
}
