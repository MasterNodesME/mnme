...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MasterNodesME masternodesme-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  masternodesme-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded masternodesme transaction") + "\n" +
                               "  masternodesme-tx [options] -create [commands]   " + _("Create hex-encoded masternodesme transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded masternodesme transaction
