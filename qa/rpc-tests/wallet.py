...
#   c) node1 mines 32 blocks, so now node 0 has 60001MNME, node 1 has 4250MNME, node2 has none.
#   d) node0 sends 601 MNME to node2, in two transactions (301 MNME, then 300 MNME).
